...
class SaaSHelper {
  ...
  def saas(): List[Cloudlet] ={
    ...
    val hosttemp_saas: Hostconfig = new Hostconfig(simulation = "mixed", model = "MixedSimulations")
    ...
    val dc0_temp_saas: Datacenterconfig = new Datacenterconfig(simulation = "saas", model = "MixedSimulations")
    ...
    val vmtemp_saas: Vmconfig = new Vmconfig(simulation = "mixed", model = "MixedSimulations")
    ...
    val cltemp_saas: Cloudletconfig = new Cloudletconfig(simulation = "mixed", model = "MixedSimulations")
