...
class IaaSHelper {
  ...
  def iaas(): List[Cloudlet] ={
    ...
    val hosttemp_iaas: Hostconfig = new Hostconfig(simulation = "mixed", model = "MixedSimulations")
    ...
    val dc0_temp: Datacenterconfig= new Datacenterconfig(simulation = "iaas", model = "MixedSimulations")
    ...
    val cltemp: Cloudletconfig= new Cloudletconfig(simulation = "mixed", model = "MixedSimulations")
