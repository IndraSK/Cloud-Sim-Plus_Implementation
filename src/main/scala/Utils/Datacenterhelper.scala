...
class Datacenterhelper {
  ...
  def createSimpleDc(dc: Datacenterconfig, cloudSim: CloudSim, hostList: util.List[Host], policy: VmAllocationPolicyAbstract): Datacenter = {
  ...
  def createNetworkDc(dc: Datacenterconfig, cloudSim: CloudSim, hostList: util.List[Host], policy: VmAllocationPolicyAbstract): Datacenter = {
  ...
  def createHost(host: Hostconfig, policy: VmSchedulerAbstract): Host = {
    //Creating hostPes
  ...
  def createIaasDc(dc: Datacenterconfig, cloudSim: CloudSim, hostList: util.List[Host], policy: VmAllocationPolicyAbstract, os: String): Datacenter = {
    val dc0 = new DatacenterSimple(cloudSim, hostList, policy)
  ...
  def createCloudLets(cl: Cloudletconfig): Cloudlet = {
